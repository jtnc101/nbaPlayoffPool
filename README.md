...
## HOW THE POOL WORKS
 ...
 5. Players can be sorted by points and name. 
  ...
  1. Web responsive page. Used css modules to avoid clasing of class name in one massive master css styles page. [example code](/nbaPlayoffPoolDocs/cssModules.JPG)
  2. 
